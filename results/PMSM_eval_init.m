...
%%
PMSMmotor.setRotationAngle(15);
PMSMmotor.plotGeometry()
PMSMmotor.plotWindingCurrent();
PMSMmotor.plotBoundariesRB();
axis off
ax = gca;
exportgraphics(ax,'PMSM_geometry.pdf','Resolution',500) 
exportgraphics(ax,'PMSM_geometry.png') 
...
set(gca, "FontSize", 16)
exportgraphics(gca,'PMSMfield0.pdf','Resolution',1000) 
exportgraphics(gca,'PMSMfield0.png') 
...
yticks([0.01:0.01:0.06])
set(gca, "FontSize", 16)
exportgraphics(gca,'Geometry0.pdf') 
exportgraphics(gca,'Geometry0.png') 
...
save("InitTorques.mat", "angles", "Torques", "currents");
...
%             disp(num2str(angles(iAngle)));
            ...
            PMSMmotor.solveMagneticPotentialNewton();
            T = SymMult * PMSMmotor.calcTorqueCoupling();
            TorquesMapInit(iCurrents, iPhase, iAngle) = T;
        end
    end
    iCurrents
end

save("InitValues.mat", "TorquesMapInit", "currentsMapInit", "PhaseAnglesInit", "angles");
